...
!exists( src/qt/beepmagnet.cpp ) {
    error( "No beepmagnet.cpp file found" )
}
...
android {
    ...
    RESOURCES = beepmagnet.qrc

macosx64 {
    message(Building BeepMAGNET Coin for macosx64)

    QMAKE_TARGET_BUNDLE_PREFIX = co.beepmagnet
    BOOST_LIB_SUFFIX=-mt
...
win32 {
    message(Building BeepMAGNET Coin for win32)
    ...
    OPENSSL_LIB_PATH=c:/deps/openssl/lib

    MINIUPNPC_INCLUDE_PATH=c:/deps
    MINIUPNPC_LIB_PATH=c:/deps/miniupnpc
    QMAKE_CXXFLAGS += -DSTATICLIB -DMINIUPNP_STATICLIB
...
android {
    message(Building BeepMAGNET Coin for android)
}

ios {
    message(Building BeepMAGNET Coin for ios)
}

!windows:!macx:!android:!ios {
    message(Building BeepMAGNET Coin for linux)
}
...
!win32 {
    ...
    LIBS += c:/deps/leveldb/libleveldb.a c:/deps/leveldb/libmemenv.a
...
HEADERS += \
    ...
    src/qt/beepmagnetgui.h \
    src/qt/beepmagnetbridge.h \
...
SOURCES += \
    ...
    src/qt/beepmagnetgui.cpp \
    src/qt/beepmagnet.cpp \
    src/qt/beepmagnetbridge.cpp \
...
macx:ICON = src/qt/res/icons/beep-magnet.icns
macx:TARGET = "BeepMAGNET Coin"
